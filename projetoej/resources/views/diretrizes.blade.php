    ...
    <div class="container">
        ...
        <div class="row">
            <div class="card border-light mb-3 div" style="max-width: 18rem;">
                <div class="card-header icon"><img src="https://img.icons8.com/ultraviolet/30/000000/trophy--v1.png"/></div>
                <div class="card-body">
            ...
            <div class="card border-light mb-3 div" style="max-width: 18rem;">
                <div class="card-header icon"><img src="https://img.icons8.com/ultraviolet/30/000000/visible.png"/></div>
                <div class="card-body">
            ...
            <div class="card border-light mb-3 div" style="max-width: 18rem;">
                <div class="card-header icon"><img src="https://img.icons8.com/ultraviolet/30/000000/racism.png"/></div>
                <div class="card-body">
